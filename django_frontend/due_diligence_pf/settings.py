"""
Django settings for due_diligence_pf project.
...
SECRET_KEY = 'django-insecure-5w8*(jey&#4o_^8xrqae&e-k9@3s)=&$49^wab)&+bk$=4!yx3'
...
ROOT_URLCONF = 'due_diligence_pf.urls'
...
WSGI_APPLICATION = 'due_diligence_pf.wsgi.application'
